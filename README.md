...
## Contributing
Create a folder with a unique name for your plugin, and include a README.md file talking about what your plugin is about and how to install it. If approved, it will be displayed in the [Lengo Labs Discord server](https://lengolabs.com/discord).
